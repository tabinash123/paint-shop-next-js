        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            ...
            <TextWrapper>
              ...
              <TypographyStyled variant="body1" paragraph style={{ fontSize: '16px', lineHeight: '1.6' }}>
                Whether you're refreshing a single room or embarking on a full home makeover, OurPaintShop is your trusted partner in creating spaces that inspire and delight.
              </TypographyStyled>
            </TextWrapper>
          </Grid>
          <Grid item xs={12} md={6}>
      ...
      <ContainerWrapper>
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            ...
            <TextWrapper>
              <TypographyStyled variant="body1" paragraph style={{ fontSize: '16px', lineHeight: '1.6' }}>
                OurPaintShop is committed to redefining the way homeowners explore and select paint colors. With our innovative online platform, we're revolutionizing the color selection process, making it more inspiring, convenient, and enjoyable than ever before.
              </TypographyStyled>
              <TypographyStyled variant="body1" paragraph style={{ fontSize: '16px', lineHeight: '1.6' }}>
              ...
              <TypographyStyled variant="body1" paragraph style={{ fontSize: '16px', lineHeight: '1.6' }}>
                With OurPaintShop, you can say goodbye to color anxiety and confidently bring your vision to life. Whether you're a seasoned DIY enthusiast or a first-time homeowner, our platform makes it easy to create beautiful, personalized spaces that you'll love coming home to.
              </TypographyStyled>
            </TextWrapper>
          </Grid>
          <Grid item xs={12} md={6}>
